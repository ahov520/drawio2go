...
export default function BottomBar({ onToggleSettings, onSave, onLoad }: BottomBarProps) {
  ...
  return (
    <div className="bottom-bar">
      ...
      {onToggleSettings && (
        <Button variant="secondary" size="md" className="bottom-bar-button button-secondary" onPress={onToggleSettings}>
          <svg
            className="w-4 h-4"
            fill="none"
            stroke="currentColor"
